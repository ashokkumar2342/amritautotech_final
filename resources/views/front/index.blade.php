     ...
     <section class="rev_slider_wrapper">
      <div id="slider1" class="rev_slider" data-version="5.0">
          <ul>
              ...
              <li data-transition="fade">
                  <img src="{{ asset('assets/images/slider/6.jpg') }}" alt="" width="1500" height="504"    data-bgrepeat="no-repeat" data-bgparallax="1">
              </li>
              <li data-transition="fade">
                  <img src="{{ asset('assets/images/slider/7_1.jpg') }}" alt="" width="1500" height="504"    data-bgrepeat="no-repeat" data-bgparallax="1">
              </li> 
              <li data-transition="fade">
                  <img src="{{ asset('assets/images/slider/8.jpg') }}" alt="" width="1500" height="504"    data-bgrepeat="no-repeat" data-bgparallax="1">
              </li>
               <li data-transition="fade">
