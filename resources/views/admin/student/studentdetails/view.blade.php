      ...
      <div class="box">       
        ...
        <ol class="breadcrumb text-right">
         <h4  style="float:left;">Student details</h4>
          @if($student->paymentType->times > count($student->studentFee))<li><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addfee">Add Fees</button></li>@endif
          <li><a href="{{ route('admin.feereceipt.view') }}" class="btn btn-info btn-sm" >Fee Receipt</a></li>
        </ol>
      </div>
      <!-- /.box-header -->
          <div class="box-body"> 
              ...
              <div class="row">
                ...
                @php
                 ...
                 endforeach
                 @endphp
                      <h4> Balence : <b>{{$student->classFee->total_fee-$totalDepFee }}</b></h4>                      
                     </div>
              </div>
                 <div class="row">

                    <div class="col-md-6">
                      <h4> Center : <b>{{ $student->centers->name }}</b></h4>                      
                     </div>
                      <div class="col-md-6">
                      <h4> Session : <b>{{ $student->sessions->date }}</b></h4>                      
                     </div>
                     <div class="col-md-6">
                      <h4> Class : <b>{{ $student->classes->name }}</b></h4>                      
                     </div>
                     <div class="col-md-6">
                      <h4> Section : <b>{{ $student->sections->name }}</b></h4>                      
                     </div>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <h4> Date Of Birth : <b>{{ $student->sections->name }}</b></h4>                      
                     </div>
                     <div class="col-md-6">
                      <h4> Date Of Birth : <b>{{ $student->sections->name }}</b></h4>                      
                     </div>
...
<section class="content">
   <table class="table table-striped box">
            <tr><th>Installment Fees </th><th>Discount</th><th>Receipt No</th><th>Receipt Date</th><th>Received Fees</th><th>Custom</th></tr>
            @php
              $totalFee=0;
            @endphp
            ...
            @endphp
            <tr><td>{{ $studentFee->installment_fees }}</td><td>{{ $studentFee->discount }}</td><td>{{ $studentFee->receipt_no }}</td><td>{{ $studentFee->receipt_date }}</td><td>{{ $studentFee->received_fee }}</td><td><a class="btn btn-warning btn-xs" href="{{ route('admin.student.fee.edit',$studentFee->id) }}"><i class="fa fa-pencil"></i></a></td></tr>
            @endforeach
</table>
</section>
