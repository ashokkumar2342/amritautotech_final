...
<head>
  ...
  <title>SB Model School Rohtak, (HR)</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="{{ route('admin.dashboard') }}" class="logo">
                ...
                <span class="logo-mini"><b>SB Model School</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">SB Model School</span>
            </a>
                   ...
                   {{--  <li class="treeview">
                    ...
                    {{-- <li class="treeview">
                     ...
                     <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          <li><a href="{{ route('admin.holidayhomework.list') }}"><i class="fa fa-circle-o"></i> Upload Assignment</a></li>
                      ...
                      <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          <li><a href="{{ route('admin.gallery.list') }}"><i class="fa fa-circle-o"></i> Upload Gallery</a></li>
