      ...
      <div class="box">   
          ...
          <div class="box-body"> 
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-12">
                 <div id="showImg">
                    <div style="height: 150px; width: 130px; background-color: #eee;">
                      <img width="130" height="150px" class="thumbnail" src="{{  ($student->picture)? $profile : asset('profile-img/user.png') }}">
                    </div>
                ...
                {{-- <div id="changeImg" class="hidden">
                  {!! Form::open(['route'=>['admin.student.profilepic.update',$student->id],'files'=>true]) !!}
                    <div class="col-md-12">
                      {!! Form::file('student_photo', ['class'=>'form-control','required']) !!}
